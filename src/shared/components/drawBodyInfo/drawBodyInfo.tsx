...
export interface IDrawBodyInfoProps {
    /**
...
export const DrawBodyInfo: React.FC<IDrawBodyInfoProps> = (props) => {
    const { name, subdomain, address, release, build, logoSrc } = props;

    invariant(address != null || subdomain != null, 'DrawBodyInfo: address or subdomain must be set.');
