...
import { DrawBodyInfo, type IDrawBodyInfoProps } from './drawBodyInfo';

describe('<GovernanceBodyInfo /> component', () => {
    const createTestComponent = (props?: Partial<IDrawBodyInfoProps>) => {
        const completeProps: IDrawBodyInfoProps = {
            ...props,
        };

        return <DrawBodyInfo {...completeProps} />;
    };
