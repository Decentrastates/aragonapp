...
export interface IAppsBodiesFieldItemDefaultProps {
    /**
...
export const AppsBodiesFieldItemDefault: React.FC<IAppsBodiesFieldItemDefaultProps> = (props) => {
    ...
    return (
        <DefinitionList.Container>
            ...
            {/* {createDrawFormUtils.isBodySafe(body) && (
